...
# 测试函数 - Actuator 响应格式（不包含 code 字段）
test_actuator() {
    local name="$1"
    local url="$2"
...
# 7.2 获取应用信息
test_actuator "应用信息" "/actuator/info" ""
